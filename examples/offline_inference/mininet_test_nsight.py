...
def run_simulation():
    ...
    info('*** Creating links\n')
    net.addLink(h1, s1, cls=TCLink, bw=1000)
    net.addLink(h2, s1)
    ...
    if results == 0: # Only run app if ping worked
        ...
        vllm_script = '/home/hkngae/vllm/examples/offline_inference/disaggregated_prefill_Nsight.py'
        ...
        server_cmd = (f'export NCCL_DEBUG=INFO; '
                    ...
                    f'{python_executable} {vllm_script} --mode prefill '
                    f'> {server_log} 2>&1 &') 
        ...
        client_cmd = (f'export NCCL_DEBUG=INFO; '
                    ...
                    f'{python_executable} {vllm_script} --mode decode ')
